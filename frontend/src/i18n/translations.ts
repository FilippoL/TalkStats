...
export const translations = {
  it: {
    ...
    androidStep5: 'Salva o condividi il file .txt',
    ...
    exportNote: '<strong>Nota:</strong> Esporta senza media per un\'elaborazione più veloce. Il file .txt esportato contiene tutti i tuoi messaggi con timestamp e nomi mittenti.',
  ...
  en: {
    ...
    androidStep5: 'Save or share the .txt file',
    ...
    exportNote: '<strong>Note:</strong> Export without media for faster processing. The exported .txt file contains all your messages with timestamps and sender names.',
